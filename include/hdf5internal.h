...
int NC4_hdf5_def_var_filterx(int ncid, int varid, const char* text);
int NC4_hdf5_inq_var_filterx_ids(int ncid, int varid, char** textp);
int NC4_hdf5_inq_var_filterx_info(int ncid, int varid, const char* id, char** textp);
