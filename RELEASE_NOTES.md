...
* Modify the .rc file support to allow us of glob-style URLs to control which key=value pairs are visible. See [Github #????](https://github.com/Unidata/netcdf-c/pull/????) for more information.
