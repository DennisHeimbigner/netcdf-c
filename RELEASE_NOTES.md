...
* Implement the DAP4 checksum changes in the [DAP4 specification](https://github.com/OPENDAP/dap4-specification/pull/34). Also implement some minor changes from an old, unmerged branch. See [Github #????](https://github.com/Unidata/netcdf-c/pull/????) for more information.
