...
static int computeattrdata(nc_type typehint, nc_type* typeidp, const NCjson* values, size_t* typelenp, int* lenp, void** datap);
...
*/
static int
computeattrdata(nc_type typehint, nc_type* typeidp, const NCjson* values, size_t* typelenp, int* countp, void** datap)
{
    int stat = NC_NOERR;
