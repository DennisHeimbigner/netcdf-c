...
int NCZ_filter_jsonize(const NC_FILE_INFO_T*, const NC_VAR_INFO_T*, struct NCZ_Filter* filter, NCjson** jfilterp);
int NCZ_filter_build(const NC_FILE_INFO_T*, NC_VAR_INFO_T* var, const NCjson* jfilter);
int NCZ_filter_setup(const NC_FILE_INFO_T* file, NC_VAR_INFO_T* var, struct NCZ_Filter* filter);
