...
int NCZ_applyfilterchain(const NC_FILE_INFO_T*, const NC_VAR_INFO_T*, NClist* chain, size_t insize, void* indata, size_t* outlen, void** outdata, int encode);
int NCZ_filter_jsonize(const NC_FILE_INFO_T*, const NC_VAR_INFO_T*, const struct NCZ_Filter* filter, NCjson** jfilterp);
int NCZ_filter_build(const NC_FILE_INFO_T*, const NC_VAR_INFO_T* var, const NCjson* jfilter);
