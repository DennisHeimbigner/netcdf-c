...
int
NCZ_s3sdkinfo(void* s3client0, const char* bucket, const char* key, size64_t* lenp, char** errmsgp)
{
    int stat = NC_NOERR;
    Aws::S3::S3Client* s3client = (Aws::S3::S3Client*)s3client0;
	...
	if(nkeys != 1) {stat = NC_EACCESS; goto done;}	
	if((stat = s3objectsinfo(object_list,"/",NULL,&lengths))) goto done;
...
int
NCZ_s3sdkread(void* s3client0, const char* bucket, const char* key, size64_t start, size64_t count, void* content, char** errmsgp)
{
    int stat = NC_NOERR;
    Aws::S3::S3Client* s3client = (Aws::S3::S3Client*)s3client0;
...
int
NCZ_s3sdkreadobject(void* s3client0, const char* bucket, const char* key, size64_t* sizep, void** contentp, char** errmsgp)
{
    int stat = NC_NOERR;
    Aws::S3::S3Client* s3client = (Aws::S3::S3Client*)s3client0;
    Aws::S3::Model::GetObjectRequest object_request;
...
*/
int
NCZ_s3sdkwriteobject(void* s3client0, const char* bucket, const char* key,  size64_t count, const void* content, char** errmsgp)
{
    int stat = NC_NOERR;
    Aws::S3::S3Client* s3client = (Aws::S3::S3Client*)s3client0;
...
*/
int
NCZ_s3sdkgetkeys(void* s3client0, const char* bucket, const char* subtree, const char* prefix, size_t* nkeysp, char*** keysp, char** errmsgp)
{
    int stat = NC_NOERR;
    Aws::S3::S3Client* s3client = (Aws::S3::S3Client*)s3client0;
    Aws::S3::Model::ListObjectsV2Request objects_request;
    ...
    if(errmsgp) *errmsgp = NULL;
    objects_request.SetBucket(bucket);
    objects_request.SetPrefix(subtree);
	...
	if((stat = s3objectsinfo(object_list,prefix,keysp,NULL))) goto done;
    } else {
...
int
NCZ_s3sdkdeletekey(void* s3client0, const char* bucket, const char* key, char** errmsgp)
{
    int stat = NC_NOERR;
    Aws::S3::S3Client* s3client = (Aws::S3::S3Client*)s3client0;
